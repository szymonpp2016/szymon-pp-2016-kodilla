...
public class CrudAppTestingApp {
    ...
    private static final String XPATH_INPUT = "//html/body/main/section[1]/form/fieldset[1]/input";
    ...
    public static void main(String[] args) {
        ...
        searchField.sendKeys("gugulec jest  -patrz nastepna sekcja");

        WebElement textareaField = driver.findElement(By.xpath(XPATH_TEXTAREA));
        textareaField.sendKeys("Gugulcem");
